  ...
  return new ImageResponse(
    (
      <div tw="h-full w-full flex flex-col justify-center bg-white items-center">
        <h1 tw="mb-2 mt-4 flex items-center justify-center p-4 text-4xl">
          {/* @ts-ignore */}
          <svg tw="w-10 h-10" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#f7931a" data-v-4fa90e7f="">
        ...
        <h2 tw="mb-8 p-8 text-center text-2xl italic text-blue-600">Your simple Fiat to Satoshi Converter</h2>
      </div>
    ),
    {
      width: 800,
